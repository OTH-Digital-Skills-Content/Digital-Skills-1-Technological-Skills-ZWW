...
* Die härteste Variante: Wenn Sie sich Ihr Repository ansehen, dann können Sie dort einen Ordner tests entdecken - Können Sie ChatGPT die Tests geben und nach einer Lösung fragen?
